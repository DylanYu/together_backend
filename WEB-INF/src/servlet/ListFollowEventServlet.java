...
public class ListFollowEventServlet extends HttpServlet {
	...
	public ListFollowEventServlet() throws SQLException, ClassNotFoundException, InstantiationException, IllegalAccessException {
		super();
	}
