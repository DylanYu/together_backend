...
public class UnfollowServlet extends HttpServlet{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			if(requestJson == null)
				...
				int success = handler.unFollow(eid, startUid, followUid);
	...
	public UnfollowServlet() throws SQLException, ClassNotFoundException, InstantiationException, IllegalAccessException {
		super();
	}
